...
const reload_pending_processes_1 = __importDefault(require("./modules/import-processes/reload-pending-processes"));
module.exports = function setupImport(io, recordModel, datasetModel, maxAttempts, attemptDelayTime, limit) {
    ...
    const { importsService, importProcessesService, transferService } = (0, services_setup_1.default)(io, datasetsRepository, importsRepository, importProcessesRepository, maxAttempts, attemptDelayTime, limit);
    const reloadPendingImportProcesses = (0, reload_pending_processes_1.default)(importProcessesRepository, importsRepository, transferService);
